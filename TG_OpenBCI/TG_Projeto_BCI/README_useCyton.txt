...
Tabela de inputs possíveis para o x0000000X(nas posições dos zeros):
 ...
 2º0 Ativação 0/1 (Ligado(padrão)/desligado)
 ...
 5º0 BIAS 0/1 (Desligado/Ligado(padrão))
 6º0 SRB2 0/1 (Desligado/Ligado(padrão))
 7º0 SRB1 0/1 (Desligado(padrão)/Ligado)
 X
...
Há comandos para a teste de impedância inicial.
